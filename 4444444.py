...
def run(playwright: Playwright) -> None:
    ...
    # page.get_by_role("link", name="My Downloads").click(timeout=150000)
    ...
    # page.get_by_role("button", name="Download").click(timeout=150000)
    # page.get_by_role("link", name="View All").click(timeout=150000)
    ...
    # page1.get_by_role("button", name="Copy download link").click(timeout=150000)
    ...
    # page.get_by_role("button", name="Copy download link").click(timeout=150000)

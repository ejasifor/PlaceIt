...
def process_item(page, context):
    ...
    page.get_by_role("button").nth(2).click(timeout=600000)
    page.get_by_role("link", name="Crop / Resize").click(timeout=600000)
    time.sleep(10)
    ...
    # Input 1280x1280
    page.get_by_role("spinbutton").first.click(timeout=600000)
    page.get_by_role("spinbutton").first.fill("1280")
    page.get_by_role("spinbutton").nth(1).click(timeout=600000)
    ...
    page.goto(updated_url, wait_until="domcontentloaded", timeout=600000)
    page.reload()#timeout=600000)
    # page.goto(upda0030ted_url, wait_until="domcontentloaded", timeout=600000)

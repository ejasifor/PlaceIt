...
def run(playwright: Playwright) -> None:
    ...
    page.goto("https://placeit.net/c/mockups/stages/crop-top-mockup-featuring-an-afro-hairstyle-woman-with-customizable-pants-m29354/editor?draftId=59603906&colorFolder_Pants%20Color=%23fd72ca&draftId=59603906&colorFolder_Crop%20Top%20Color=%23ffffff",
               wait_until="domcontentloaded",
               timeout=6000000  # 60 seconds  
               )
    ...
    page.get_by_role("button", name="Upload Image 750x750px").set_input_files("36.png")

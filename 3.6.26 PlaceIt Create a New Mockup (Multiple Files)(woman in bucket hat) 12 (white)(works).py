...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_role("button", name="Upload Image 750x750px").set_input_files("235.png")
    ...
    for index, num in enumerate(file_numbers, start=1):
        ...
        # page.locator('button:has-text("Hat design")').hover(timeout=600000)
        page.locator('button:has-text("900x800px")').click(timeout=600000)
        # page.get_by_role("button").filter(has_text="Remove this Image").locator("a").click(timeout=600000)
        page.get_by_role("listitem").filter(has_text="Remove this Image").locator("a").click(timeout=600000)
...
#remove shirt image
        page.locator(".p-icon.p-sm.remove-gray").first.click(timeout=600000)
